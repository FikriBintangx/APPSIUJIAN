...
public class PdfPanel extends JPanel {
    ...
    public PdfPanel(String filePath) {
        ...
        JButton btnZoomIn = createNavButton("🔍+", "Perbesar");
        JButton btnZoomOut = createNavButton("🔍-", "Perkecil");
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected void done() {
                if (doc != null) {
                    ...
                    lblPage.setText("❌ File tidak dapat dibaca atau rusak.");
    ...
    private void renderPage() {
        ...
        // Render in worker to allow smooth UI
