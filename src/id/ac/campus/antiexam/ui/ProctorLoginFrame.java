...
public class ProctorLoginFrame extends JFrame {
    ...
    private final Color COL_PRIMARY = new Color(124, 58, 237); // Purple for Proctor
        ...
        JButton btn = new JButton(text) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (getModel().isPressed()) {
                    ...
                    g2.setColor(COL_PRIMARY.brighter());
                } else {
