...
public class LecturerLoginFrame extends JFrame {
    ...
    public LecturerLoginFrame() {
        ...
        JLabel lblUserTitle = new JLabel("Username Dosen");
        ...
        txtUsername.setToolTipText("Masukkan username dosen");
        ...
        txtPassword.setToolTipText("Masukkan password akun dosen");
    ...
    private void performLogin() {
        ...
        if (u.isEmpty() || p.isEmpty()) {
            lblError.setText("⚠️ Lengkapi username dan password.");
            return;
        }
        ...
        try {
            if (authRepository.loginLecturer(u, p)) {
                ...
                lblError.setText("⚠️ Username atau password salah.");
            }
        } catch (Exception ex) {
            lblError.setText("⚠️ Error: " + ex.getMessage());
        }
    }
